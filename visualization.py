...
class TieredGraph:
    ...
    def show(self):
        ...
        for edge in edges:
            ax.plot([edge[0].position[0], edge[1].position[0]], [edge[0].position[1], edge[1].position[1]], color = "black", zorder = 1)
    ...
    def P1(self):
        ...
        RHS.add_node(i := Vertex(((self.corners[0][0] + self.corners[1][0])/2, (self.corners[0][1] + self.corners[2][1])/2), "I", "red"))
    ...
    def P2(self, level): # TODO: uwzględnić poziom
        ...
        RHS.add_node(new_v1_5 := Vertex(((v1.position[0] + v2.position[0])/2, (v1.position[1] + v2.position[1])/2), "E", "green"))
        RHS.add_node(new_v2 := Vertex(v2.position, "E", "green"))
        RHS.add_node(new_v3 := Vertex(v3.position, "E", "green"))
        RHS.add_node(new_v3_5 := Vertex(((v3.position[0] + v4.position[0])/2, (v3.position[1] + v4.position[1])/2), "E", "green"))
        RHS.add_node(new_v4 := Vertex(v4.position, "E", "green"))



        RHS.add_node(new_i_left := Vertex(((new_v1.position[0] + new_v1_5.position[0])/2, (new_v1.position[0] + new_v3.position[1])/2), "I", "orange"))
       
        RHS.add_node(new_i_right := Vertex(((new_v1_5.position[0] + new_v3.position[0])/2, (new_v1_5.position[0] + new_v3_5.position[1])/2), "I", "orange"))
        ...
        edges = [(new_v1, new_v1_5), (new_v1_5, new_v2), (new_v1, new_v3), (new_v3, new_v3_5), (new_v1_5, new_v3_5), (new_v3_5, new_v4), (new_v2, new_v4),
